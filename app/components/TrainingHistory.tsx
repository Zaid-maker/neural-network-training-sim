...
export const TrainingHistory: React.FC<TrainingHistoryProps> = ({ errors }) => {
  ...
  return (
    <div className="rounded-lg bg-white/5 p-4">
      <h2 className="mb-4 text-xl font-semibold">Training History</h2>
      <div className="relative">
        <canvas
          ref={canvasRef}
          className="w-full rounded-lg border border-gray-300/20 bg-gray-900"
        />
        <div className="mt-2 text-sm text-gray-400">Training Iterations →</div>
        <div
